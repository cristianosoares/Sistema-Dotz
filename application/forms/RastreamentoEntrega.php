...
class Application_Form_RastreamentoEntrega extends Zend_Form
{
    ...
    public function init()
    {
       ...
       // $id->addFilter('Int');
        ...
        $this->addElements(array($id_pedido_dotz,$id_pedido,$produtoiddotz,$id_item,$preco,$frete,$peso,$nr_rastreio,$numero_nf,$numero_linha_nf,$submit)); 
