...
class Application_Form_ObservacaoEvento extends Zend_Form
{
    ...
    ->setAttrib('rows', '20')->setAttrib('class', 'ckeditor');
       ...
       $pergunta1 = new Zend_Form_Element_Radio('pergunta1');
        ...
        $this->addElements(array($id,$qt_garrafas,$observacoes,$pergunta1,$pergunta2,$pergunta3,$pergunta4,$pergunta5,$pergunta6,$pergunta7,$pergunta8,$pergunta9,$submit));
    ...
    // defina o arquivo que vai carregar o HTML decorador  
        $this->setDecorators( array( array('ViewScript', array('viewScript' => 'formularioObservacao.phtml'))));
